				...
				<table className="home_table home_table-location">
					...
					<thead>
						<tr>
							...
							<td className="home_table-column">{company.headquarters ? company.headquarters.state : null}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">City</td>
							<td className="home_table-column">{company.headquarters ? company.headquarters.city : null}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">Address</td>
							<td className="home_table-column">{company.headquarters ? company.headquarters.address : null}</td>
						</tr>
